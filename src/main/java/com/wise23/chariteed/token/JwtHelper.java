...
public class JwtHelper {
    ...
    public JwtHelper(@Value("${accessTokenSecret}") String accessTokenSecret, @Value("${refreshTokenSecret}") String refreshTokenSecret, @Value("${com.wise23.chariteed.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @Value("${com.wise23.chariteed.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
    ...
    public String generateRefreshToken(UserData user, RefreshToken refreshToken) {
        return JWT.create()
                .withIssuer(issuer)
                .withSubject(user.getId().toString())
